...
function Dashboard() {
 ...
 const handleloanname = async (loan) => {
  try {
    ...
    <div className="min-h-screen bg-blue-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        ...
        <p className="mt-6 text-lg text-gray-600 max-w-3xl mx-auto">
          Choose from our flexible loan options designed to meet your specific
          financial needs
        </p>
      </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {loan.subcategories.map((subcat, idx) => (
                      <span
                        key={idx}
                        className="text-xs bg-white/80 text-gray-700 px-2 py-1 rounded"
                      >
                        {subcat}
                      </span>
                    ))}
